...
Number.prototype.pad = function () {
  var before = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
  var after = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
  var str = this.toString().split('.');
  var ls = str[0].padStart(before, '0');
  var rs = str[1].padEnd(after, '0');
  return "".concat(ls, ".").concat(rs);
};
